...
"""Create a theta-theta plot and do an eigenvalue decomposition.

Example runs on file generated by ``examples/screen2ds.py``.
"""
...
with hdf5.open('dynspec.h5') as fh:
    # Also get the input simulation numbers.
    dynspec = fh.read()
    f = fh.frequency
    fobs = f[f.shape[0]//2]
